  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        ...
        post :create, {:review => { "venue_id" => "invalid value" }}, valid_session
        assigns(:review).should be_a_new(Review)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested review" do
        ...
        Review.any_instance.should_receive(:update).with({ "venue_id" => "1" })
        put :update, {:id => review.to_param, :review => { "venue_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the review as @review" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Review.any_instance.stub(:save).and_return(false)
        put :update, {:id => review.to_param, :review => { "venue_id" => "invalid value" }}, valid_session
        assigns(:review).should eq(review)
      end
